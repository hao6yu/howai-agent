...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get privacyBanner => 'Tú controlas tus datos. Las solicitudes de IA y las funciones de sincronización habilitadas se procesan de forma segura mediante los servicios de HowAI. Sin anuncios.';
  ...
  @override
  String get instructionsSection7Line4 => '• Las funciones de IA pueden procesar contenido de forma segura mediante los servicios Supabase y OpenAI de HowAI. Gestiona la personalización en los ajustes de Memoria.';
  ...
  @override
  String get chatInputHint => 'Pregunta a HowAI';
  ...
  @override
  String get guestAiLimitReached => 'Has alcanzado el límite diario de IA para invitados. Inicia sesión o inténtalo mañana.';

  @override
  String get aiUsageLimitReached => 'Has alcanzado el límite actual de IA. Inténtalo de nuevo más tarde.';
  ...
  @override
  String get textSizeChangeNote => 'Usa el control para previsualizar el texto en HowAI.';
  ...
  @override
  String get knowledgeHubSettingsTitle => 'Memoria y personalización';

  @override
  String get knowledgeHubSettingsDescription => 'Elige cuándo HowAI puede usar o aprender datos duraderos. Los secretos y datos sensibles no se guardan automáticamente.';

  @override
  String get knowledgeHubPersonalization => 'Usar memoria en las respuestas';

  @override
  String get knowledgeHubPersonalizationDesc => 'Usa elementos activos del Centro de conocimiento para personalizar el chat y la voz.';

  @override
  String get knowledgeHubLearnChats => 'Aprender de chats más largos';

  @override
  String get knowledgeHubLearnChatsDesc => 'Revisa datos útiles indicados por el usuario después de conversaciones significativas.';

  @override
  String get knowledgeHubLearnVoice => 'Aprender después de llamadas de voz';

  @override
  String get knowledgeHubLearnVoiceDesc => 'Revisa llamadas con al menos cinco turnos del usuario para encontrar datos duraderos.';

  @override
  String get knowledgeHubSettingsSave => 'Guardar ajustes';

  @override
  String get knowledgeHubSettingsSaved => 'Ajustes de memoria guardados.';

  @override
  String knowledgeHubSuggestedTitle(int count) {
    return 'Recuerdos sugeridos ($count)';
  }

  @override
  String get knowledgeHubSuggestedDescription => 'Revisa los datos que HowAI dedujo antes de usarlos.';

  @override
  String get knowledgeHubSuggestionAdd => 'Añadir';

  @override
  String get knowledgeHubSuggestionDismiss => 'Descartar';

  @override
  String get knowledgeHubSuggestionReviewFailed => 'No se pudo actualizar ese recuerdo sugerido.';
  ...
  @override
  String get voiceCallFeatureTitle => 'Voz y visión';
  ...
  @override
  String get voiceCallOneMinuteRemaining => 'Queda 1 minuto en esta llamada';

  @override
  String get voiceCallSelectProfileFirst => 'Selecciona un perfil primero.';

  @override
  String get voiceCallMicrophoneDeniedPermanently => 'Se denegó el acceso al micrófono. Actívalo en Configuración > Privacidad > Micrófono.';

  @override
  String get voiceCallMicrophoneRequired => 'Se requiere permiso de micrófono para las llamadas de voz.';

  @override
  String get voiceCallNotConfigured => 'La llamada de voz no está configurada. Revisa tu configuración.';

  @override
  String get voiceCallConnectionTimedOut => 'La conexión agotó el tiempo. Inténtalo de nuevo.';

  @override
  String get voiceCallConnectionFailed => 'No se pudo conectar la llamada de voz. Inténtalo de nuevo.';

  @override
  String get voiceCallConnectionIssue => 'Hubo un problema de conexión durante la llamada de voz. Inténtalo de nuevo.';

  @override
  String get voiceCallEndedTitle => 'Llamada finalizada';

  @override
  String voiceCallSaveTranscriptPrompt(String duration) {
    return 'Tu llamada de $duration se ha grabado.\n\n¿Quieres guardar la transcripción como una conversación nueva?';
  }
  ...
  @override
  String get voiceCallSaveAndView => 'Guardar y ver';

  @override
  String get voiceCallTranscriptSaveFailed => 'No se pudo guardar la transcripción. Inténtalo de nuevo.';

  @override
  String get voiceCallSavingTranscript => 'Guardando transcripción...';

  @override
  String get voiceCallMicMuted => 'Micrófono silenciado';

  @override
  String get voiceCallAiSpeaking => 'La IA está hablando...';

  @override
  String get voiceCallConnecting => 'Conectando...';

  @override
  String get voiceCallTapToStart => 'Toca para empezar';
  ...
  @override
  String get voiceCallFreeTier => 'Plan gratuito';

  @override
  String get voiceCallCalling => 'Llamando...';

  @override
  String get voiceCallConnected => 'Conectado';

  @override
  String get voiceCallUnmute => 'Activar micrófono';

  @override
  String get voiceCallMute => 'Silenciar';

  @override
  String get voiceCallEndCall => 'Finalizar llamada';

  @override
  String voiceCallConversationTitle(String time) {
    return 'Llamada de voz - $time';
  }

  @override
  String get speakButtonLabel => 'Hablar';

  @override
  String get speakButtonTooltip => 'Iniciar llamada de voz';
  ...
  @override
  String get voiceNoVoicesAvailable => 'No hay voces disponibles en este dispositivo';
  ...
  @override
  String get thinkingLevel => 'Nivel de razonamiento';
  ...
  @override
  String get thinkingLevelNote => 'Los niveles más altos tardan más y usan más tokens de razonamiento.';
}
