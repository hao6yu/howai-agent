...
Paid interactive requests have no separate per-route, per-user, daily, or
monthly cost ceiling. They remain subject to the hourly abuse limit and the
global daily/monthly safety ceilings. Automations retain their independent
route budget so scheduled work cannot consume the full interactive capacity.
